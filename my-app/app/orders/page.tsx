    ...
    <div style={styles.outerWrapper}>
      <div style={styles.container}>
        ...
        <div style={styles.bottomNav}>
          ...
          <a href="/orders" style={{ ...styles.navItem, color: "#a0592f" }}>📋<span>Orders</span></a>
...
const styles: { [key: string]: React.CSSProperties } = {
  ...
  title: { textAlign: "center", fontSize: "20px", fontWeight: 800, color: "#2b1c12", marginBottom: "16px" },
  ...
  customerName: { fontWeight: 800, fontSize: "14px", color: "#2b1c12" },
